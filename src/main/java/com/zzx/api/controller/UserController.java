...
import com.zzx.common.model.vo.LoginUserVO;
import com.zzx.common.model.vo.UserVO;
import com.zzx.api.service.UserService;
import com.zzx.api.model.dto.user.*;
...
public class UserController {
     ...
     * 获取秘钥
     *
     * @param userSecretKeyRequest
     * @return
     */
    @PostMapping("/get/key")
    public String getSecretKey(UserSecretKeyRequest userSecretKeyRequest) {
        User user = userService.query().eq("accessKey", userSecretKeyRequest.getAccessKey()).one();
        ThrowUtils.throwIf(user==null,ErrorCode.NOT_FOUND_ERROR);
        return SignUtil.getSign(userSecretKeyRequest.getParamJSON(), user.getSecretKey());
    }
    // endregion
